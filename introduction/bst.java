class Node {
    ...
    /*
     * When a node is deleted if it has children, those children
     * must change of parent, so that's what this function does.
     * */
...
public class Bst {
    ...
    public static void bst_print (Node root)
    {
        ...
        /*
         * The point of all this is print the tree something like:
         * root: <root-value>
         * left_child_value <- parent_value -> right_child_value
         * if it does not have some child will be printed "null".
         * */
        if ( root.get_left() != null ) {
